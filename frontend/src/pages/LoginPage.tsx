  ...
  return (
    <div className="min-h-screen flex flex-col hero-gradient overflow-x-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-1/4 left-1/4 w-64 md:w-96 h-64 md:h-96 rounded-full opacity-5"
          style={{ background: 'radial-gradient(circle, oklch(0.72 0.12 75), transparent)' }} />
        <div className="absolute bottom-1/4 right-1/4 w-48 md:w-64 h-48 md:h-64 rounded-full opacity-5"
          style={{ background: 'radial-gradient(circle, oklch(0.72 0.12 75), transparent)' }} />
      </div>
      ...
      <div className="flex-1 flex flex-col lg:flex-row relative">
        ...
        <div className="lg:w-1/2 relative overflow-hidden">
          ...
          <div className="absolute inset-0"
            style={{ background: 'linear-gradient(to right, transparent, oklch(0.08 0.008 260 / 0.8))' }} />
                ...
                {[
                  ...
                  <div key={label} className="flex items-center gap-2">
                    ...
                    <span className="text-xs tracking-widest uppercase"
                      style={{ color: 'oklch(0.75 0.005 260)' }}>{label}</span>
                  </div>
                ))}
              </div>
            </div>
          ...
          <div className="w-full max-w-md space-y-8 md:space-y-10">
            ...
            <div className="text-center space-y-3">
              ...
              <p className="text-sm leading-relaxed"
                style={{ color: 'oklch(0.6 0.005 260)' }}>
                Sign in to explore the future of garment care. Experience precision ironing, reimagined.
              </p>
            </div>
            ...
            <div className="grid grid-cols-3 gap-4 pt-4 border-t border-border/30">
              {[
                ...
                <div key={label} className="text-center">
                  <div className="font-serif text-lg md:text-xl font-bold gold-text">{value}</div>
                  <div className="text-xs tracking-wider uppercase mt-1"
                    style={{ color: 'oklch(0.5 0.005 260)' }}>{label}</div>
                </div>
              ))}
            </div>
          </div>
