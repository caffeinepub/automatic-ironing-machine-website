    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-12 md:py-16"
      ...
      <div className="max-w-2xl w-full text-center space-y-8 md:space-y-10">
        ...
        <div className="flex justify-center">
          <div className="w-20 h-20 md:w-24 md:h-24 flex items-center justify-center border-2 border-destructive/40"
            style={{ background: 'oklch(0.577 0.245 27.325 / 0.1)' }}>
            <XCircle size={40} className="md:hidden" style={{ color: 'oklch(0.704 0.191 22.216)' }} />
            <XCircle size={48} className="hidden md:block" style={{ color: 'oklch(0.704 0.191 22.216)' }} />
          </div>
        </div>
        ...
        <div className="space-y-4">
          <p className="text-xs tracking-widest uppercase"
            style={{ color: 'oklch(0.704 0.191 22.216)' }}>Payment Cancelled</p>
          ...
          <p className="text-base md:text-lg leading-relaxed px-2"
            ...
            You can try again or return to browse our product.
          </p>
        </div>

        {/* Reasons */}
        <div className="border border-border/30 p-5 md:p-8 text-left space-y-4"
          style={{ background: 'oklch(0.12 0.01 260)' }}>
          <div className="flex items-center gap-2">
            <HelpCircle size={16} className="gold-text" />
            <h3 className="font-serif text-sm md:text-base font-semibold"
              style={{ color: 'oklch(0.96 0.005 85)' }}>Common Reasons</h3>
          </div>
          <ul className="space-y-2">
            {[
              ...
              <li key={reason} className="flex items-center gap-2">
                ...
                <span className="text-sm" style={{ color: 'oklch(0.6 0.005 260)' }}>{reason}</span>
              </li>
            ))}
          </ul>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <button
            onClick={() => navigate({ to: '/checkout', search: { quantity: '1' } })}
