  ...
  return (
    <div className="min-h-screen bg-charcoal-950 text-white">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto pt-20">
          ...
          <p className="text-silver-300 text-lg md:text-xl max-w-2xl mx-auto mb-10 leading-relaxed">
            AIron uses advanced AI and precision steam technology to deliver a flawless press on
            every garment — automatically, in under 90 seconds.
          </p>
      ...
      <section className="py-20 px-4 max-w-6xl mx-auto">
        <div className="text-center mb-14">
          ...
          <p className="text-silver-400 max-w-xl mx-auto text-lg">
            Every garment treated with the care it deserves, powered by cutting-edge technology.
          </p>
        </div>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-silver-400 leading-relaxed mb-6">
              AIron's sleek, compact form factor fits seamlessly into any laundry room or wardrobe
              space. The intuitive touch interface and companion app make scheduling and monitoring
              effortless.
            </p>
            <ul className="space-y-3">
              {[
                ...
                <li key={point} className="flex items-start gap-3 text-silver-300 text-sm">
      ...
      <section className="relative py-24 px-4 overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl mx-auto text-center">
          ...
          <p className="text-silver-300 text-lg mb-8 leading-relaxed">
            From crisp dress shirts to delicate blouses, AIron handles every garment with
            professional-grade precision — so you always look your best.
          </p>
          <button
            onClick={() => navigate({ to: '/features' })}
      ...
      <section className="py-20 px-4 max-w-2xl mx-auto text-center">
        <p className="text-gold-400 font-sans text-sm tracking-widest uppercase mb-3">Pricing</p>
        <h2 className="font-serif text-3xl md:text-4xl font-bold text-white mb-4">
          One Price, Endless Convenience
        </h2>
        <p className="text-silver-400 mb-10">
          No subscriptions. No hidden fees. Just a one-time investment in effortless style.
        </p>

        <div className="bg-charcoal-900 border border-gold-500/40 rounded-3xl p-10 shadow-gold">
          <p className="text-silver-400 text-sm uppercase tracking-widest mb-2">AIron Pro</p>
          <p className="font-serif text-6xl font-bold text-white mb-1">
            ₹20,000
          </p>
          <p className="text-silver-500 text-sm mb-8">One-time purchase · Free shipping</p>
