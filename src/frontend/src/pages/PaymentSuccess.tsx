...
import { ArrowRight, CheckCircle2, Mail, Package, Phone } from "lucide-react";
    ...
    >
      <div className="max-w-2xl w-full text-center space-y-8 md:space-y-10">
        ...
        <div className="flex justify-center">
          <div
            className="w-20 h-20 md:w-24 md:h-24 flex items-center justify-center border-2 border-gold/40"
        ...
        <div className="space-y-4">
          <p className="text-xs tracking-widest uppercase gold-text">
            Order Confirmed
          </p>
          <h1
          ...
          >
            Your AIron Automatic Ironing Machine
            {quantity > 1 ? ` (×${quantity})` : ""} has been ordered
            successfully. You'll receive a confirmation email shortly with your
        ...
        {/* Order Details */}
        <div
          className="border border-border/30 p-5 md:p-8 text-left space-y-6"
          ...
          <div className="space-y-4">
            {[
              ...
              <div key={title} className="flex gap-3 md:gap-4">
                <div
                  className="w-8 h-8 flex items-center justify-center shrink-0 border border-gold/30"
                  style={{ background: "oklch(0.72 0.12 75 / 0.1)" }}
                >
        ...
        {/* Product Summary */}
        <div
          className="flex items-center gap-4 md:gap-6 border border-border/20 p-4 md:p-6"
        ...
        >
          ...
          <div className="flex-1 text-left min-w-0">
            <p
              className="font-serif text-sm md:text-base font-semibold truncate"
              style={{ color: "oklch(0.96 0.005 85)" }}
            >
